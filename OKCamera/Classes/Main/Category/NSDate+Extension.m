...
- (NSString *)CYFormatTimeStr {
    ...
    // 微博的创建日期
    NSDate *createDate = self;//[fmt dateFromString:_createTime];
    // 当前时间
...
+ (NSDate *)dateWithTimeNumber:(NSInteger)timeNumber {
    return [NSDate dateWithTimeIntervalSince1970:timeNumber];
}
